        ...
        <div className="min-h-screen pt-20 flex items-center justify-center bg-cover bg-center"
            ...
            <div className="w-full max-w-4xl mx-auto text-center p-8 bg-opacity-50 bg-white rounded-lg shadow-lg">
                ...
                <div className="bg-[#5672B8]/30 shadow-lg rounded-xl p-3 pb-5">
                    ...
                    <div className="bg-[#040B29DB]/50 backdrop-blur-md shadow-lg w-full h-60 rounded-lg mt-3 overflow-y-auto p-3">
                    ...
                    <div className="flex justify-evenly items-center gap-3 font-medium text-white mt-5">
                        <button
                            ...
                            className={`bg-[#0A044033] px-4 py-1 rounded-md ${sortType === "rank" ? "bg-green-500 text-white" : ""}`}>
                            Rank
                        </button>
                        <button
                            onClick={() => handleSort("points")}
                            className={`bg-[#0A044033] px-4 py-1 rounded-md ${sortType === "points" ? "bg-blue-500 text-white" : ""}`}>
                            Points
                        </button>
                        <button
                            onClick={() => handleSort("winning")}
                            className={`bg-[#0A044033] px-4 py-1 rounded-md ${sortType === "winning" ? "bg-yellow-500 text-white" : ""}`}>
                            Winning
                        </button>
                    </div>
